export const data = [
  ...
  },
  {
    ...
    bgColor: "bg-teal",
    fontStyle: "font-backcountry text-[#f9a03f] font-bold",
    ytLink: "",
    description: `Backcountry Description`,
