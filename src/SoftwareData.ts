export const data = [
  {
    ...
    description: `Fueled by the grit of a seasoned mountain biker and the curiosity of a budding software developer, I embarked on a journey to create an application that has the potential to revolutionize the bike maintenance experience. This idea struck me as I was refurbishing my mountain bike suspension. I was grappling with a problem that most mountain bikers are all too familiar with - remembering the last service date of their suspension and then trying to calculate the number of riding hours since then, a key piece of data used by suspension manufacturers to recommend service intervals.
