  ...
  return (
    <nav className="bg-darkBlue w-full h-24 flex justify-between py-2.5">
      ...
      <section className="flex items-center">
        ...
        <img className="h-12 mx-3" src="https://img.icons8.com/15616D/ios/100/null/climbing-anchor.png" alt="climbing anchor icon" />
      </section>
    </nav>
  )
}
